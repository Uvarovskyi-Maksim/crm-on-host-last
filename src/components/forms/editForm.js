                            ...
                            <div className='user_modal_left_main'>
                                <div className='user_modal_left_block'>
                                    <div className="content">
                                        ...
                                        <div className='el'>Дата созвона: {formatDateTime(new Date(selectedClient.selectedDate))}</div>
                                    </div>
                                ...
                                <div className='user_modal_right_block'>
                                    <div className="content">
                                        ...
                                        <div className='el'><div style={{ display: "flex" }}><div>Номер телефона:</div> <div style={{ marginLeft: "10px" }}>{selectedClient.phone} <br /> {selectedClient.secondPhone}</div></div></div>
                                    </div>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="input_td"><div>Second Phone:</div><input type="text" name="secondPhone" value={registrationDataClient.secondPhone} onChange={handleRegistrationClientChange} required /></td>
